...
export default async function RootLayout({children}:{children:React.ReactNode}){const initial=await getStoreData();return <html lang="en" suppressHydrationWarning><body><StoreTheme><StoreProvider initial={initial}><StoreShell>{children}</StoreShell></StoreProvider></StoreTheme></body></html>}
