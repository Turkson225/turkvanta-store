...
export function StoreProvider({children,initial}:{children:ReactNode;initial:StoreData}){
 ...
 useEffect(()=>{if(ready){localStorage.setItem('turkvanta-cart',JSON.stringify(cart));localStorage.setItem('turkvanta-wishlist',JSON.stringify(wishlist));}},[cart,wishlist,ready]);
